// !==================Linklist ===================
// * A link list is a linear data structure that includes a series of connected node.
// * Each node contains a data value and a pointer which points to the next node. So the order of the node is not given ny ther physical placemnet in the memory.
// * Unlike array, the list element can be easily inserted or removed without reallocation or reorganozation of entire structure. It maynot be sotroed continuiously in memory
// * Drawback: Random access of element is not feasiable. Accesing element has linear time complexity
// * It supports three main operations:
// *  # Insertion at front/end / or at given index
// *  # deletion by index or value
// * # Search by value
// * Link list usage:
// *  # all application of stack and queue are application of linklist.
// *  # Image viewer
